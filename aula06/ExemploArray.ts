// notas é do tipo Array de números
// const notas: number = 8, 9, 5,7
// a const notas é do tipo numero, e vai armazenar numeros.
...
for(let nota of notas){ //nota representa cada item dentro da Collection Notas
